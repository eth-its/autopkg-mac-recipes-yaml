...
#######################################################################
#
# EndNote Uninstaller Script for Jamf Pro
#
...
# Inputted variables
major_version="$4"
app_name="EndNote $major_version"
...
bundle_destination="/Library/Application Support/Microsoft/Office365/User Content.localized/Startup.localized/Word"
rm -Rf "$bundle_destination/EndNote CWYW Word 16.bundle" ||:
rm -Rf "$bundle_destination/EndNote CWYW Word 2016.bundle" ||:

# Try to Forget the packages if we can find a match
# Loop through the remaining parameters
/usr/sbin/pkgutil --pkgs | /usr/bin/grep "com.endnote.EndNote$major_version.pkg" | /usr/bin/xargs /usr/bin/sudo /usr/sbin/pkgutil --forget
