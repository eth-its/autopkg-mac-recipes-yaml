...
#######################################################################
#
# Mendeley Desktop Uninstaller Script for Jamf Pro
#
#######################################################################

delete_plugins() {
    # additional step for removing Mendeley plugins
...
/usr/sbin/pkgutil --pkgs | /usr/bin/grep -i "com.mendeley.desktop.pkg" | /usr/bin/xargs /usr/bin/sudo /usr/sbin/pkgutil --forget
