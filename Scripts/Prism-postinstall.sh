...
config_contents="<configuration><silent-activation>true</silent-activation><serial-number>$serial_number</serial-number><check-for-updates>false</check-for-updates><measure-units>metric</measure-units></configuration>"
