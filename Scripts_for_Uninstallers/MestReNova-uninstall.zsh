...
/bin/rm -Rf "/Library/Application Support/Mestrelab Research S.L." ||:

# Forget packages
echo "Forgetting packages"
/usr/sbin/pkgutil --forget com.mestrelabs.mnova.pkg ||:
/usr/sbin/pkgutil --forget ch.ethz.id.mnovalicense.pkg ||:
