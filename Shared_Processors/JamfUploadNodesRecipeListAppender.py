...
__all__ = ["JamfUploadNodesRecipeListAppender"]


class JamfUploadNodesRecipeListAppender(Processor):
    description = (
    ...
    def main(self):
        ...
        nodes_recipe_list_path = self.env.get("nodes_recipe_list_path")
        ...
        if (
            ...
            recipe_name = recipe_file.replace(".jamf.recipe.yaml", "-nodes.jamf")
...
if __name__ == "__main__":
    PROCESSOR = JamfUploadNodesRecipeListAppender()
