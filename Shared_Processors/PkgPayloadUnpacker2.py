...
"""See docstring for PkgPayloadUnpacker2 class"""
...
__all__ = ["PkgPayloadUnpacker2"]


class PkgPayloadUnpacker2(Processor):
    """Unpacks a package payload. This is attempted using ditto, but if that fails,
    resorts to try to use aa instead."""
